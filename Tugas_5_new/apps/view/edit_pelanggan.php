                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="id" name="id_pelanggan" value="<?php echo $Pelanggan['id_pelanggan']; ?>" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="nama" class="form-label">Nama Pelanggan</label>
                                <input type="text" class="form-control" id="nama" name="nm_pelanggan" value="<?php echo $Pelanggan['nm_pelanggan']; ?>" required>
                            </div>
                            <div class="mb-3">
