                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="POST"> <!-- Atur action dan method sesuai kebutuhan -->
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="kode" name="kd_barang" value="<?php echo $barang['kd_barang']; ?>" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="nama" class="form-label">Nama Barang</label>
                                <input type="text" class="form-control" id="nama" name="nm_barang" value="<?php echo $barang['nm_barang']; ?>" required>
                            </div>
                            <div class="mb-3">
