        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="POST"> <!-- Add your form action and method -->
                            <div class="mb-3">
                                <label for="id" class="form-label">Id Pelanggan</label>
                                <input type="text" class="form-control" id="id" name="id_pelanggan" required>
                            </div>
                            <div class="mb-3">
                                <label for="nama" class="form-label">Nama Pelanggan</label>
                                <input type="text" class="form-control" id="nama" name="nm_pelanggan" required>
                            </div>
                            <div class="mb-3">
